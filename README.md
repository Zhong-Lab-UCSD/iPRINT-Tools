...
- At the stage of protein-protein interactions identification, for each chimeric read pair, we apply various statistical tests and cutoffs, including chi-square test, an odds ratio cutoff and a positive read count cutoff to finally identify protein-protein associations (PPAs) . <br /> 
